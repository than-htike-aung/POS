...
if(isset($_POST['btnsaveorder'])){
  ...
  tbl_invoice(customer_name,order_date,subtotal,tax,discount,total,paid,due,payment_type)
...
<div class="content-wrapper">
              ...
              <div class="box-body">
                ...
                <div class="input-group">
                  <div class="input-group-addon">
                    ...
                    <input type="text" class="form-control" name="txttax" id="txttax" required readonly readonly>
                </div>
                  </div>
    ...
    <div class="form-group">
     <label>
        <input type="radio" name="rb" class="minimal" value="Cash" checked> CASH
    </label>
    <label>
      <input type="radio" name="rb" class="minimal" value="Card"> CARD
    </label>
    <label>
      <input type="radio" name="rb" class="minimal" value="Check"> CHECK
