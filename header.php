                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                              <?php echo $_SESSION['useremail']; ?> - Web Developer
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="category.php"><i class="fa fa-list-alt"></i> 
                    <span>Category</span></a>
                </li>

                <li>
                    <a href="addproduct.php"><i class="fa fa-product-hunt"></i> 
                    <span>Add Product</span></a>
                </li>

                <li>
                    <a href="productlist.php"><i class="fa fa-th-list"></i> 
                    <span>Product List</span></a>
                </li>

                <li>
                    <a href="createorder.php"><i class="fa fa-th-list"></i> 
                    <span>Create Order</span></a>
                </li>

                <li>
                    <a href="orderlist.php"><i class="fa fa-th-list"></i> 
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="graphreport.php"><i class="fa fa-circle-o"></i> Graph Report</a></li>
                ...
                <li>
                    <a href="registration.php"><i class="fa fa-registered"></i> 
